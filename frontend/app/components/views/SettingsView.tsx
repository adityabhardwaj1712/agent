...
export default function SettingsView() {
  ...
  const save = async () => {
    try {
      ...
      toast('Failed to synchronize configuration', 'err');
    }
  };
                 ...
                 <div className="space-y-10">
                    <section className="ms-set-section">
                       ...
                       <div className="ms-input-grid">
                          <div className="ms-field">
                             ...
                             <select 
                                className="fi" 
                                value={systemSettings.reasoning_core}
                                onChange={e => setSystemSettings({...systemSettings, reasoning_core: e.target.value})}
                             >
                          ...
                          <div className="ms-field">
                             ...
                             <div className="flex items-center gap-4">
                                <input 
                                   type="range" 
                                   className="ms-range" 
                                   value={systemSettings.auto_scaling}
                                   onChange={e => setSystemSettings({...systemSettings, auto_scaling: parseInt(e.target.value)})}
                                />
                                <span className="font-mono text-xs">{systemSettings.auto_scaling}%</span>
                             </div>
                          </div>
                       </div>
                    </section>
                    ...
                    <section className="ms-set-section">
                       ...
                       <div className="space-y-3">
                          <div className="ms-toggle-row" onClick={() => setSystemSettings({...systemSettings, hyperthreaded: !systemSettings.hyperthreaded})}>
                             <div className="flex-1">
                                <div className="name">Hyper-threaded Reasoning</div>
                                <div className="sub">Allow agents to branch logic paths concurrently.</div>
                             </div>
                             <div className={`ms-toggle ${systemSettings.hyperthreaded ? 'on' : 'off'}`}></div>
                          </div>
                          <div className="ms-toggle-row" onClick={() => setSystemSettings({...systemSettings, circuit_breaker: !systemSettings.circuit_breaker})}>
                             <div className="flex-1">
                             ...
                             <div className={`ms-toggle ${systemSettings.circuit_breaker ? 'on' : 'off'}`}></div>
                          </div>
