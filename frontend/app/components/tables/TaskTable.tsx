              ...
              {tasks.length === 0 ? (
                ...
                tasks.map(task => (
                  <tr key={task.task_id} className="group">
                    ...
                    <td>
                      <div className="ms-task-desc">{task.payload}</div>
                    </td>
                    ...
                    <td>
                       <div className="flex items-center gap-2">
                         ...
                         {(['queued', 'processing', 'in_progress'].includes(task.status.toLowerCase())) && (
                           <button 
                             className="ms-btn ms-btn-sm" 
                             ...
                             onClick={async () => {
                               try {
                                 ...
                                 toast('Task cancellation signal sent', 'ok');
                                 fetchTasks();
                               } catch (err: any) {
                                 toast('Failed to cancel task: ' + err.message, 'err');
                               }
                             }}
                           >
